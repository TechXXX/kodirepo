...
CONTEXT_MENU_ITEMS = {
    # Browse Lists
    '$ADDON[plugin.video.themoviedb.helper.patched 32235]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,related_lists,{})',
    ...
    # Trakt Options
    '$ADDON[plugin.video.themoviedb.helper.patched 32295]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,sync_trakt,{})',
    ...
    # TMDb User Options
    '$ADDON[plugin.video.themoviedb.helper.patched 32522]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,sync_tmdb,{})',
        'setting': 'contextmenu_sync_tmdb',
        'episode': {'tmdb_type': '{tmdb_type}', 'tmdb_id': '{tmdb_id}', 'season': '{season}', 'episode': '{episode}'},
        'other': {'tmdb_type': '{tmdb_type}', 'tmdb_id': '{tmdb_id}'}
    },
    # Refresh Details
    '$ADDON[plugin.video.themoviedb.helper.patched 32233]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,refresh_details,{})',
    ...
    # Modify Artwork
    '$ADDON[plugin.video.themoviedb.helper.patched 32118]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,modify_artwork,{})',
    ...
    # Add to Library
    '$LOCALIZE[20444]': {
        'command': 'RunScript(plugin.video.themoviedb.helper.patched,add_to_library,{})',
