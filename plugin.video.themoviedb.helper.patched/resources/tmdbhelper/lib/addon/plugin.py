...
KODIPLUGIN = jurialmunkey.plugin.KodiPlugin('plugin.video.themoviedb.helper.patched')
ADDON = KODIPLUGIN._addon
ADDONPATH = KODIPLUGIN._addon_path
ADDONNAME = KODIPLUGIN._addon_name
ADDONDATA = 'special://profile/addon_data/plugin.video.themoviedb.helper.patched/'
PLUGINPATH = u'plugin://plugin.video.themoviedb.helper.patched/'

get_setting = KODIPLUGIN.get_setting
set_setting = KODIPLUGIN.set_setting
get_localized = KODIPLUGIN.get_localized

encode_url = jurialmunkey.parser.EncodeURL(u'plugin://plugin.video.themoviedb.helper.patched/').encode_url
