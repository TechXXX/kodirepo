...
def import_easynews():
	...
	# if get_setting('fenlight.aisearch.easynews.api_version') == '0': return EasyNewsAPI()
...
class EasyNewsAPI:
	def __init__(self):
		...
		self.username = get_setting('fenlight.aisearch.easynews_user', 'empty_setting')
		self.password = get_setting('fenlight.aisearch.easynews_password', 'empty_setting')
