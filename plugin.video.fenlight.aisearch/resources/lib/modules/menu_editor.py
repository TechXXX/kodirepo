...
default_path = 'plugin://plugin.video.fenlight.aisearch?mode=navigator.main&full_list=true'
...
class MenuEditor:
	...
	def _get_menu_item(self, path):
		return dict(parse_qsl(path.replace('plugin://plugin.video.fenlight.aisearch/?','')))
