...
def build_episode_list(params):
	def _process():
		for item in episodes_data:
			try:
				...
				set_properties({'fenlight.aisearch.extras_params': extras_params, 'fenlight.aisearch.options_params': options_params, 'episode_type': episode_type})
	...
	watched_title = 'Trakt' if watched_indicators == 1 else 'fenlight.aisearch'
