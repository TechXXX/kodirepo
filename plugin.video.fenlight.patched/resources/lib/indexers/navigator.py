...
class Navigator:
	...
	def changelog_utils(self):
		fenlight_clogpath = tp('special://home/addons/plugin.video.fenlight.patched/resources/text/changelog.txt')
	...
	def tips(self):
		tips_location = 'special://home/addons/plugin.video.fenlight.patched/resources/text/tips'
